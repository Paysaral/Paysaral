...
class WaterPaymentScreen extends StatefulWidget {
  final Map<String, dynamic> billData;
  final Map<String, dynamic> boardData;

  const WaterPaymentScreen({
    super.key,
  ...
  @override
  State<WaterPaymentScreen> createState() => _WaterPaymentScreenState();
}

class _WaterPaymentScreenState extends State<WaterPaymentScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '₹${widget.billData['billAmount']} paid to ${widget.boardData['name']}',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _receiptRow('Water Board', widget.boardData['name']),
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            // ✅ JADOO: Scroll hata kar sirf Expanded aur Spacer lagaya hai, ab screen lock rahegi!
            Expanded(
              child: Padding(
                      ...
                      child: Row(
                        children: [
                          Container(
                            width: 52, height: 52,
                            decoration: BoxDecoration(
                              color: (widget.boardData['color'] as Color)
                                  .withOpacity(0.12),
                              borderRadius: BorderRadius.circular(14),
                            ),
                            child: Icon(
                              widget.boardData['icon'] as IconData,
                              color: widget.boardData['color'] as Color,
                              size: 26,
                            ),
                          ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(widget.boardData['name'],
                                    style: const TextStyle(
                                        fontSize: 15,
                                        fontWeight: FontWeight.w700,
                                        color: Colors.black87)),
                                const SizedBox(height: 3),
                                Text(widget.boardData['fullName'],
                                    style: TextStyle(
                                        fontSize: 12,
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                _summaryRow('Consumer Name',
                                    widget.billData['consumerName']),
                                _summaryRow('Consumer No.',
                                    widget.billData['consumerNo']),
                                _summaryRow('Bill Month',
                                    widget.billData['billMonth']),
                                _summaryRow('Due Date',
                                    widget.billData['dueDate'],
                                    valueColor: const Color(0xFFE53935)),
                                _summaryRow('Water Usage',
                                    '${widget.billData['usage']} KL'),
