...
class GasPaymentScreen extends StatefulWidget {
  final Map<String, dynamic> billData;
  final Map<String, dynamic> gasData; // ✅ Discom ki jagah Operator Data
  final bool isB2B; // ✅ JADOO: B2B Privacy Logic

  const GasPaymentScreen({
    super.key,
    required this.billData,
    required this.gasData,
    this.isB2B = false, // Default is false (B2C)
  });

  @override
  State<GasPaymentScreen> createState() => _GasPaymentScreenState();
}

class _GasPaymentScreenState extends State<GasPaymentScreen> {
  ...
  // ✅ JADOO: Indian Currency Comma Formatter (E.g., 2000.00 -> 2,000.00)
  ...
  // ✅ FIXED _showSuccessSheet (With B2B Privacy)
    ...
    showModalBottomSheet(
      ...
      builder: (_) => Padding(
        ...
        child: SingleChildScrollView(
          physics: const ClampingScrollPhysics(), // ✅ Bottom sheet bouncing fix
          child: Column(
            ...
            children: [
              ...
              Text(
                '₹${widget.billData['billAmount']} paid to ${widget.gasData['name']}',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _receiptRow('Provider', widget.gasData['name']),
                    _receiptRow('Amount', '₹${widget.billData['billAmount']}'),
                    _receiptRow('Date', '26 Mar 2026'),
                    _receiptRow('Txn ID',
                        'GAS${DateTime.now().millisecondsSinceEpoch.toString().substring(6)}'),

                    // ✅ JADOO: B2B Privacy. Agar Retailer hai to commission receipt me nahi dikhega.
                    // Agar regular user (B2C) hai, to Cashback dikhega.
                    if (!widget.isB2B)
                      _receiptRow('Cashback Earned', '+₹15.00', valueColor: Colors.orange.shade700),
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            // ✅ JADOO: SingleChildScrollView ko hata diya gaya hai, ab screen lock rahegi!
            Expanded(
              child: Padding(
                      ...
                      child: Row(
                        children: [
                          Container(
                            width: 52, height: 52,
                            decoration: BoxDecoration(
                              color: (widget.gasData['color'] as Color).withOpacity(0.12),
                              borderRadius: BorderRadius.circular(14),
                            ),
                            child: Icon(
                              widget.gasData['icon'] as IconData,
                              color: widget.gasData['color'] as Color,
                              size: 26,
                            ),
                          ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(widget.gasData['name'],
                                    style: const TextStyle(
                                        fontSize: 15,
                                        fontWeight: FontWeight.w700,
                                        color: Colors.black87)),
                                const SizedBox(height: 3),
                                Text(widget.gasData['fullName'],
                                    style: TextStyle(
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                _summaryRow('Booking Month', widget.billData['billMonth']),
                                _summaryRow('Due Date', widget.billData['dueDate'],
                                    valueColor: const Color(0xFFE53935)),

                                // ✅ Gas specific: Unit ki jagah Type likha hai
                                _summaryRow('Type', '${widget.billData['units']}'),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          // ✅ JADOO: Yahan lag gaya Comma formatter
                          Text(
