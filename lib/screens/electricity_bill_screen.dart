...
class _ElectricityBillScreenState extends State<ElectricityBillScreen> {
  ...
  void _onConsumerChanged(String value) {
    ...
    // Min digits hone ke baad auto fetch
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: TextField(
                                          ...
                                          onChanged: _onConsumerChanged, // ✅ AUTO FETCH
                                          showCursor: true,
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  _billRow('Units Consumed',
                                      '${fetchedBill!['units']} kWh'),
                                  const SizedBox(height: 8),
                                  Divider(color: Colors.grey.shade100),
                                  const SizedBox(height: 8),
                                  Row(
                              ...
                              children: [
                                ListTile(
                                  ...
                                  onTap: () {
                                    ...
                                    _onConsumerChanged(r['consumer']); // ✅ Auto fetch on tap
                                  },
                                ),
