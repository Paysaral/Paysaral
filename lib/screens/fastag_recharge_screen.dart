...
class _FastagRechargeScreenState extends State<FastagRechargeScreen> {
  ...
  final List<Map<String, dynamic>> fastagBanks = [
    {'name': 'IDFC FIRST Bank', 'fullName': 'IDFC Bank Fastag', 'category': 'Top Banks', 'icon': Icons.account_balance_rounded, 'color': const Color(0xFF9E0059)},
    {'name': 'ICICI Bank', 'fullName': 'ICICI Bank Fastag', 'category': 'Top Banks', 'icon': Icons.account_balance_rounded, 'color': const Color(0xFFD32F2F)},
    {'name': 'HDFC Bank', 'fullName': 'HDFC Bank Fastag', 'category': 'Top Banks', 'icon': Icons.account_balance_rounded, 'color': const Color(0xFF1565C0)},
    {'name': 'Paytm Fastag', 'fullName': 'Paytm Payments Bank', 'category': 'Top Banks', 'icon': Icons.account_balance_rounded, 'color': const Color(0xFF0288D1)},
    {'name': 'State Bank of India', 'fullName': 'SBI Fastag', 'category': 'Top Banks', 'icon': Icons.account_balance_rounded, 'color': const Color(0xFF1976D2)},
    {'name': 'Axis Bank', 'fullName': 'Axis Bank Fastag', 'category': 'Popular Banks', 'icon': Icons.account_balance_rounded, 'color': const Color(0xFF880E4F)},
  ];
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          // ✅ JADOO: CustomScrollView ko hata kar Column kar diya hai. Hero Top fixed rahega!
          body: Column(
            children: [
